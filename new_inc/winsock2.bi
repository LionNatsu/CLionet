...
declare function accept_ alias "accept" (byval as SOCKET, byval as sockaddr ptr, byval as integer ptr) as SOCKET
declare function bind_ alias "bind" (byval as SOCKET, byval as sockaddr ptr, byval as integer) as integer
declare function closesocket_ alias "closesocket" (byval as SOCKET) as integer
declare function connect_ alias "connect" (byval as SOCKET, byval as sockaddr ptr, byval as integer) as integer
declare function ioctlsocket_ alias "ioctlsocket" (byval as SOCKET, byval as integer, byval as u_long ptr) as integer
declare function getpeername_ alias "getpeername" (byval as SOCKET, byval as sockaddr ptr, byval as integer ptr) as integer
declare function getsockname_ alias "getsockname" (byval as SOCKET, byval as sockaddr ptr, byval as integer ptr) as integer
declare function getsockopt_ alias "getsockopt" (byval as SOCKET, byval as integer, byval as integer, byval as zstring ptr, byval as integer ptr) as integer
declare function inet_addr_ alias "inet_addr" (byval as zstring ptr) as uinteger
declare function inet_ntoa_ alias "inet_ntoa" (byval as in_addr) as zstring ptr
declare function listen_ alias "listen" (byval as SOCKET, byval as integer) as integer
declare function recv_ alias "recv" (byval as SOCKET, byval as zstring ptr, byval as integer, byval as integer) as integer
declare function recvfrom_ alias "recvfrom" (byval as SOCKET, byval as zstring ptr, byval as integer, byval as integer, byval as sockaddr ptr, byval as integer ptr) as integer
declare function send_ alias "send" (byval as SOCKET, byval as zstring ptr, byval as integer, byval as integer) as integer
declare function sendto_ alias "sendto" (byval as SOCKET, byval as zstring ptr, byval as integer, byval as integer, byval as sockaddr ptr, byval as integer) as integer
declare function setsockopt_ alias "setsockopt" (byval as SOCKET, byval as integer, byval as integer, byval as zstring ptr, byval as integer) as integer
declare function shutdown_ alias "shutdown" (byval as SOCKET, byval as integer) as integer
declare function socket_ alias "socket" (byval as integer, byval as integer, byval as integer) as SOCKET
declare function gethostbyaddr_ alias "gethostbyaddr" (byval as zstring ptr, byval as integer, byval as integer) as hostent ptr
declare function gethostbyname_ alias "gethostbyname" (byval as zstring ptr) as hostent ptr
declare function getservbyport_ alias "getservbyport" (byval as integer, byval as zstring ptr) as servent ptr
declare function getservbyname_ alias "getservbyname" (byval as zstring ptr, byval as zstring ptr) as servent ptr
declare function getprotobynumber_ alias "getprotobynumber" (byval as integer) as protoent ptr
declare function getprotobyname_ alias "getprotobyname" (byval as zstring ptr) as protoent ptr
declare function WSAStartup_ alias "WSAStartup" (byval as WORD, byval as LPWSADATA) as integer
declare function WSACleanup_ alias "WSACleanup" () as integer
declare sub WSASetLastError_ alias "WSASetLastError" (byval as integer)
declare function WSAGetLastError_ alias "WSAGetLastError" () as integer
declare function WSAIsBlocking_ alias "WSAIsBlocking" () as BOOL
declare function WSAUnhookBlockingHook_ alias "WSAUnhookBlockingHook" () as integer
declare function WSASetBlockingHook_ alias "WSASetBlockingHook" (byval as FARPROC) as FARPROC
declare function WSACancelBlockingCall_ alias "WSACancelBlockingCall" () as integer
declare function WSAAsyncGetServByName_ alias "WSAAsyncGetServByName" (byval as HWND, byval as u_int, byval as zstring ptr, byval as zstring ptr, byval as zstring ptr, byval as integer) as HANDLE
declare function WSAAsyncGetServByPort_ alias "WSAAsyncGetServByPort" (byval as HWND, byval as u_int, byval as integer, byval as zstring ptr, byval as zstring ptr, byval as integer) as HANDLE
declare function WSAAsyncGetProtoByName_ alias "WSAAsyncGetProtoByName" (byval as HWND, byval as u_int, byval as zstring ptr, byval as zstring ptr, byval as integer) as HANDLE
declare function WSAAsyncGetProtoByNumber_ alias "WSAAsyncGetProtoByNumber" (byval as HWND, byval as u_int, byval as integer, byval as zstring ptr, byval as integer) as HANDLE
declare function WSAAsyncGetHostByName_ alias "WSAAsyncGetHostByName" (byval as HWND, byval as u_int, byval as zstring ptr, byval as zstring ptr, byval as integer) as HANDLE
declare function WSAAsyncGetHostByAddr_ alias "WSAAsyncGetHostByAddr" (byval as HWND, byval as u_int, byval as zstring ptr, byval as integer, byval as integer, byval as zstring ptr, byval as integer) as HANDLE
declare function WSACancelAsyncRequest_ alias "WSACancelAsyncRequest" (byval as HANDLE) as integer
declare function WSAAsyncSelect_ alias "WSAAsyncSelect" (byval as SOCKET, byval as HWND, byval as u_int, byval as integer) as integer
declare function htonl_ alias "htonl" (byval as u_long) as u_long
declare function ntohl_ alias "ntohl" (byval as u_long) as u_long
declare function htons_ alias "htons" (byval as u_short) as u_short
declare function ntohs_ alias "ntohs" (byval as u_short) as u_short
...
declare function gethostname_ alias "gethostname" (byval as zstring ptr, byval as integer) as integer
